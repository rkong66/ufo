...
#ifndef UFO_OPERATORS_RADARREFLECTIVITY_MICROPHYSICSOPTIONS_H_
#define UFO_OPERATORS_RADARREFLECTIVITY_MICROPHYSICSOPTIONS_H_

#include "oops/util/parameters/ParameterTraits.h"

namespace ufo {

/// Microphysics scheme options for radar reflectivity operators
/// This enum is shared across all radar reflectivity operators (PPRO, DirectZDA, etc.)
...
#endif  // UFO_OPERATORS_RADARREFLECTIVITY_MICROPHYSICSOPTIONS_H_
