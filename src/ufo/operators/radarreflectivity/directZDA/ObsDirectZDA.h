...
namespace ufo {
  ...
  // Microphysics scheme options shared by all radar reflectivity operators
  // (PPRO, DirectZDA, etc.)
  // Moved this part outside so that different operators can share the same options.
  // Each operator may only support a subset of these microphysics schemes. K.R. Oct. 2025
